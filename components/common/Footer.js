      ...
      <footer className="vh-25">
        ...
        >
          <div
            ...
            style={{ backgroundColor: "#0b0e38", color: "#fff" }}
          >
                  ...
                  <div className="footer__widget footer-col-1 ">
                    ...
                    <div className="footer__widget-content">
                      <div className="footer__widget-info">
                        <p>
                          Khalil Zai Group of Colleges is committed to
                          delivering quality education, fostering academic
                          excellence, and preparing students for a bright future
                        </p>
                        ...
                        <div className="footer__social">
                          ...
                          <ul>
                            <li>
                              <a
                                href="https://www.facebook.com/khalilzaimodelschoolpeshawar"
                                className="fb"
                              >
                            ...
                            <li>
                              <a
                                href="https://www.youtube.com/@khalilzaieducationnetwork"
                ...
                <div className="row">
                  <div className="col-xxl-12">
                    <div className="footer__copyright text-center">
                      <p>© 2025 IQNaut. All Rights Reserved</p>
                    </div>
                  </div>
                </div>
              </div>
