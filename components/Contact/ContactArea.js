                     ...
                     <div className="contact__info white-bg p-relative z-index-1">
                        ...
                        <div className="contact__info-inner white-bg">
                                 ...
                                 <div className="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div className="contact__info-text">
                                              <h4>Peshawar Campus</h4>
                                                <p>
                                                 <a target="_blank" rel="noreferrer" href="https://www.google.com/maps/place/Khalil+Zai+Group+of+Colleges,+Ring+Road,+Peshawar">
                                 ...
                                 <div className="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div className="contact__info-text">
                                       <h4>Email us directly</h4>
                                          <p>
                                            <a href="mailto:care@khalilzaicolleges.com">care@khalilzaicolleges.com</a>
                                          </p>
                                          <p>
                                            <a href="mailto:info@khalilzaicolleges.com">info@khalilzaicolleges.com</a>
                                          </p>
                                 ...
                                 <div className="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div className="contact__info-text">
                                       ...
                                       <p><a href="tel:+923001234567">+92 300 1234567</a></p>
                                        <p><a href="tel:+92912345678">+92 91 2345678</a></p>
                           ...
                           <div className="contact__social pl-30">
                              <h4>Follow Us</h4>
                              <ul>
                                 <li><a href="https://www.facebook.com/khalilzaimodelschoolpeshawar" className="fb" ><i className="fa-brands fa-facebook-f"></i></a></li>
                                 <li><a href="https://www.youtube.com/@khalilzaieducationnetwork" className="pin" ><i className="fa-brands fa-youtube"></i></a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
