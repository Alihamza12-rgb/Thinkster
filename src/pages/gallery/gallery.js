...
export default function Gallery() {
  ...
  const baseImages = [
    { src: "/assets/img/gallery/gallery-img-1.jpg", alt: "Gallery Image 1" },
    { src: "/assets/img/gallery/gallery-img-2.jpg", alt: "Gallery Image 2" },
    { src: "/assets/img/gallery/gallery-img-3.jpg", alt: "Gallery Image 3" },
    { src: "/assets/img/gallery/gallery-img-4.jpg", alt: "Gallery Image 4" },
    { src: "/assets/img/gallery/gallery-img-5.jpg", alt: "Gallery Image 5" },
    { src: "/assets/img/gallery/gallery-img-6.jpg", alt: "Gallery Image 6" },
  ];
