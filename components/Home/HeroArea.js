...
const HeroArea = () => {
  const sliderData = [
    ...
    {
      id: 3,
      title: "Empowering students with knowledge, character, and skills for success.",
      img: "/assets/img/slider/slider-5.jpg",
    },
    {
      id: 4,
      title: "Inspiring minds, building futures, and shaping leaders for tomorrow.",
      ...
      <div className="slider__active">
        ...
        >
          {sliderData.map((slider) => (
            <SwiperSlide
              key={slider.id}
              className="slider__item swiper-slide p-relative slider__height d-flex align-items-center z-index-1 w-full"
            >
              {/* Background Image */}
