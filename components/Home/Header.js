              ...
              <div className="row align-items-center">
                ...
                <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                  <div className="header__info">
                    <ul>
                      <li>
                        <a href="mailto:kgcpeshawar2025@gmail.com" aria-label="Send email to kgcpeshawar2025@gmail.com">
                          ...
                          kgcpeshawar2025@gmail.com
                        </a>
                      </li>
                      <li>
                        <Link href="https://maps.app.goo.gl/w42jupTL7DGer68q9">
